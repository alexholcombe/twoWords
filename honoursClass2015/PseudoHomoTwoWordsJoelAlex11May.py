...
numWordsInStream = 24
wordsUnparsed="nail, jail, keep, weep, boat, foam, game, maim, leaf, beef, milk, silk, goal, foal, move, loom, toad, mode, home, dome, call, gall, bird, burn" #24 default words
...
cueColor = [1.,1.,1.]
letterColor = [1.,1.,1.]
cueRadius = 8 #6 deg in Goodbourn & Holcombe
...
#letter size 2.5 deg
SOAms = 160 #Battelli, Agosta, Goodbourn, Holcombe mostly using 133
...
def calcAndPredrawStimuli(wordList, textStimuliStream1, textStimuliStream2):
    del textStimuliStream1[:]
    del textStimuliStream2[:]
    print('At beginning of calcAndPredrawStimuli, textStimuliStream1=',textStimuliStream1)
    ...
    for i in range(0,numWordsInStream): #draw the words that will be used on this trial, the first 26 of the shuffled list
       word = copy.deepcopy(wordList[ i ])  #     #[ idxsIntoWordList[i] ]
    ...
    return idxsStream1, idxsStream2, textStimuliStream1, textStimuliStream2
...
conditions = {'leftCongruent','rightCongruent','leftIncongruent','rightIncongruent'}
for cuePos in cuePositions:
   for rightResponseFirst in [False,True]:
      for bothWordsFlipped in [False]:
       for condition in conditions:
        stimList.append( {'condition':condition, 'cuePos':cuePos, 'rightResponseFirst':rightResponseFirst,
...
print('condition\ttargetIdentity1\ttargetIdentity2\tprimeIdentity1\tprimeIdentity2\t',file=dataFile,end='')
...
def do_RSVP_stim(thisTrial, seq1, seq2, proportnNoise,trialN):
    ...
    primePos = cuesPos[0] -1
    if thisTrial['condition'] == 'leftCongruent':
        #Left stream congruent prime set
        whichStreamItemIsTheCue1 = seq1[ primePos ] 
        targetIdentity1 = textStimuliStream1[ seq1[ cuesPos[0] ] ]
        targetIdentity1 = targetIdentity1.text
        print(' Your target text in the left stream =',targetIdentity1)
        targetIdentity2='dummkopf'
        primeIdentity2='dummkopf'
        if targetIdentity1 == "nail":
            primeIdentity1 = "nale"
        elif targetIdentity1 == "jail":
            primeIdentity1 = "jale"
        elif targetIdentity1 == "keep":
            primeIdentity1 = "keap"
        elif targetIdentity1 == "weep":
            primeIdentity1 = "weap"
        elif targetIdentity1 == "boat":
            primeIdentity1 = "bote"
        elif targetIdentity1 == "foam":
            primeIdentity1 = "fome"
        elif targetIdentity1 == "game":
            primeIdentity1 = "gaim"
        elif targetIdentity1 == "maim":
            primeIdentity1 = "mame"
        elif targetIdentity1 == "leaf":
            primeIdentity1 = "leef"
        elif targetIdentity1 == "beef":
            primeIdentity1 = "beaf"
        elif targetIdentity1 == "milk":
            primeIdentity1 = "milc"
        elif targetIdentity1 == "silk":
            primeIdentity1 = "silc"
        elif targetIdentity1 == "goal":
            primeIdentity1 = "gole"
        elif targetIdentity1 == "foal":
            primeIdentity1 = "fole"
        elif targetIdentity1 == "move":
            primeIdentity1 = "moov"
        elif targetIdentity1 == "loom":
            primeIdentity1 = "lume"
        elif targetIdentity1 == "toad":
            primeIdentity1 = "tode"
        elif targetIdentity1 == "mode":
            primeIdentity1 = "moad"
        elif targetIdentity1 == "home":
            primeIdentity1 = "hoam"
        elif targetIdentity1 == "dome":
            primeIdentity1 = "doam"
        elif targetIdentity1 == "call":
            primeIdentity1 = "cawl"
        elif targetIdentity1 == "gall":
            primeIdentity1 = "gawl"
        elif targetIdentity1 == "bird":
            primeIdentity1 = "burd"
        elif targetIdentity1 == "burn":
            primeIdentity1 = "bern"
        else:
            print('Unexpected targetIdentity1, it was ',targetIdentity1)
            print('Unexpected primeIdentity1, it was ',primeIdentity1)
        textStimuliStream1[ whichStreamItemIsTheCue1 ].setText( primeIdentity1 )
        print('Your prime text in the left stream =',primeIdentity1)
    elif thisTrial['condition'] == 'leftIncongruent':
        #Left stream incongruent prime set
        whichStreamItemIsTheCue1 = seq1[ primePos ] 
        targetIdentity2 = textStimuliStream2[ seq2[ cuesPos[0] ] ]
        targetIdentity2 = targetIdentity2.text
        print(' Your target text in the right stream =',targetIdentity2)
        targetIdentity1='dummkopf'
        primeIdentity2='dummkopf'
        if targetIdentity2 == "nail":
            primeIdentity1 = "nale"
        elif targetIdentity2 == "jail":
            primeIdentity1 = "jale"
        elif targetIdentity2 == "keep":
            primeIdentity1 = "keap"
        elif targetIdentity2 == "weep":
            primeIdentity1 = "weap"
        elif targetIdentity2 == "boat":
            primeIdentity1 = "bote"
        elif targetIdentity2 == "foam":
            primeIdentity1 = "fome"
        elif targetIdentity2 == "game":
            primeIdentity1 = "gaim"
        elif targetIdentity2 == "maim":
            primeIdentity1 = "mame"
        elif targetIdentity2 == "leaf":
            primeIdentity1 = "leef"
        elif targetIdentity2 == "beef":
            primeIdentity1 = "beaf"
        elif targetIdentity2 == "milk":
            primeIdentity1 = "milc"
        elif targetIdentity2 == "silk":
            primeIdentity1 = "silc"
        elif targetIdentity2 == "goal":
            primeIdentity1 = "gole"
        elif targetIdentity2 == "foal":
            primeIdentity1 = "fole"
        elif targetIdentity2 == "move":
            primeIdentity1 = "moov"
        elif targetIdentity2 == "loom":
            primeIdentity1 = "lume"
        elif targetIdentity2 == "toad":
            primeIdentity1 = "tode"
        elif targetIdentity2 == "mode":
            primeIdentity1 = "moad"
        elif targetIdentity2 == "home":
            primeIdentity1 = "hoam"
        elif targetIdentity2 == "dome":
            primeIdentity1 = "doam"
        elif targetIdentity2 == "call":
            primeIdentity1 = "cawl"
        elif targetIdentity2 == "gall":
            primeIdentity1 = "gawl"
        elif targetIdentity2 == "bird":
            primeIdentity1 = "burd"
        elif targetIdentity2 == "burn":
            primeIdentity1 = "bern"
        else:
            print('Unexpected targetIdentity2, it was ',targetIdentity2)
            print('Unexpected primeIdentity1, it was ',primeIdentity1)
        textStimuliStream1[ whichStreamItemIsTheCue1 ].setText( primeIdentity1 )
        print('Your prime text in the left stream =',primeIdentity1)
    elif thisTrial['condition'] == 'rightIncongruent':
        #Right stream incongruent prime set
        whichStreamItemIsTheCue2 = seq2[ primePos ] 
        targetIdentity1 = textStimuliStream1[ seq1[ cuesPos[0] ] ]
        targetIdentity1 = targetIdentity1.text
        print(' Your target text in the left stream =',targetIdentity1)
        targetIdentity2='dummkopf'
        primeIdentity1='dummkopf'
        if targetIdentity1 == "nail":
            primeIdentity2 = "nale"
        elif targetIdentity1 == "jail":
            primeIdentity2 = "jale"
            ...
            print('Unexpected targetIdentity1, it was ',targetIdentity1)
            print('Unexpected primeIdentity2, it was ',primeIdentity2)
        textStimuliStream2[ whichStreamItemIsTheCue2 ].setText( primeIdentity2 )
        print('Your prime text in the right stream =',primeIdentity2)
    elif thisTrial['condition'] == 'rightCongruent':
        #Right stream congruent prime set
        whichStreamItemIsTheCue2 = seq2[ primePos ] 
        targetIdentity2 = textStimuliStream2[ seq2[ cuesPos[0] ] ]
        targetIdentity2 = targetIdentity2.text
        print(' Your target text in the right stream =',targetIdentity2)
        ...
        print('Your prime text in the right stream =',primeIdentity2)
    # End prime set
    else: print('Unexpectd condition!!')
    print(thisTrial['condition'],'\t',targetIdentity1,'\t',targetIdentity2,'\t',primeIdentity1,'\t',primeIdentity2,file=dataFile,end='\t')
...
if doStaircase:
    ...
    while (not staircase.finished) and expStop==False: #staircase.thisTrialN < staircase.nTrials
        ...
        idxsStream1, idxsStream2, textStimuliStream1, textStimuliStream2 = calcAndPredrawStimuli(wordList,textStimuliStream1,textStimuliStream2)
    ...
    while nDoneMain < trials.nTotal and expStop==False: #MAIN EXPERIMENT LOOP
        ...
        sequenceStream1, sequenceStream2, textStimuliStream1, textStimuliStream2 = calcAndPredrawStimuli(wordList,  textStimuliStream1, textStimuliStream2 )
        cuesPos,correctAnswerIdxsStream1,correctAnswerIdxsStream2, ts  = \
