...
wordDur1 = 100 #Fast 35
wordDur2 = 100 #Slow 50
...
letterColor = [1,1,1] #[1.,1.,1.] [use -0.62 for difficult contrast]
...
if myDlg.OK: #unpack information from dialogue box
   ...
   if doStaircase:
       ...
       defaultNoiseLevel = 80 #int (thisInfo[ dlgLabelsOrdered.index('defaultNoiseLevel') ])
else: 
